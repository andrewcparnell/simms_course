...
The liver in particular has a large quantity of lipids, and in this example, we apply a simple numerical correction based on **[citation needed]**. This correction is weighted by the C/N ratio, such that high amounts of C require a greater correction.
