...
mydata %>% group_by(Taxon) %>% summarise(count = length(Taxon),
                                         mC = mean(d13C), 
                                         sdC = sd(d13C), 
                                         mN = mean(d15N), 
                                         sdN = sd(d15N))
