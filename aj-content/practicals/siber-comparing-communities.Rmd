...
# we have 4 groups in each community and we want to plot them 
...
And that pretty is pretty much that for comparing these metrics across communities, except perhaps to make a probabalistic statement about how dNr (for example) differs between __Community 1__ and __Community 2__. In this case, what is the probability that dNr in Community 1 is less than dNr in Community 2?
