...
overlap.G2.G3 <- maxLikOverlap("1.2", "1.3", siber.example, p = 0.95, n =)
...
overlap.G2.G3["overlap"] / overlap.G2.G3["area.1"]

overlap.G2.G3["overlap"] / overlap.G2.G3["area.2"]

overlap.G2.G3["overlap"] / (overlap.G2.G3["area.1"] + overlap.G2.G3["area.2"])
