...
These will install the most up to date versions of the package. Note: if you are on a Mac you might need to install X11 from [http://www.xquartz.org](http://www.xquartz.org). You may get a pop up window be asking if you want 'additional build tool'. Please select 'yes'.
