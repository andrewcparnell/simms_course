...
-	R: [http://www.r-project.org](http://www.r-project.org): please install the most recent version for your system; we will assume this version throughout this course. If you want to run an older version or a custom setup then we may not be able to help with compatability issues that may arise. 

-	Rstudio (optional but strongly recommended): [https://www.rstudio.com](https://www.rstudio.com) - again install the most recent version
