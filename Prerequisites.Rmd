...
```{r,eval=FALSE}
install.packages(c('rjags', 'compositions', 'devtools', 'tidyverse', 'vegan'))
...
These will install the most up to date versions of the packages `update.packages(ask = FALSE)`. You might run into the following problems:
...
If you run into any problems please drop us a line at <andrew.parnell@ucd.ie> (for SIAR/simmr/MixSIAR queries) or <a.jackson@tcd.ie> (for SIBER/SIDER queries).
