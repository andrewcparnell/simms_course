...
MixSIAR should be installed by following the instructions here: [https://github.com/brianstock/MixSIAR](https://github.com/brianstock/MixSIAR). Make sure to follow the instruction for the full installation with the GUI, as we will be using this to teach MixSIAR. If you run into problems just install the standard version with `install.packages('MixSIAR')`.
