...
model {
  ...
  alpha ~ dnorm(0,100^-2) # Note: these are all vague priors
  beta ~ dnorm(0,100^-2)
  sigma ~ dunif(0,100)
}
'
...
'
data=list(y=consumers,s_1_mean=sources[1,1],s_1_sd=sources[1,2],
...
- Another questions (which we will look at in a later session) is whether this is the 'best' model for the data
