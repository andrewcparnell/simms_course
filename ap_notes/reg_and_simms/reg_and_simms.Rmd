...
```{r,fig.align='center'}
plot(density(model_run$BUGSoutput$sims.list$p_1),xlab='Proportion',
...
```
```{r}
y_pred_quantiles = apply(model_run$BUGSoutput$sims.list$y_pred,2,'quantile',probs=c(0.05,0.95))
