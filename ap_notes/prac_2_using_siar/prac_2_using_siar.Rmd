...
Welcome to practical 2! In this practical, we will go through:
...
This document is a slightly friendlier and more up to date version of the [SIAR manual](http://mathsci.ucd.ie/~parnell_a/SIAR_For_Ecologists.pdf).
...
Finally, the matrix plot (discussed in module 5) can be created with:
