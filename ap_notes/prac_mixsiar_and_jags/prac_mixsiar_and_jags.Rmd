...
Assuming you have followed the [instructions](https://github.com/brianstock/MixSIAR/blob/master/Manual/mixsiar_manual_3.1.pdf) for installing MixSIAR you can run it with:
