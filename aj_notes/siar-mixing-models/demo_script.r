...
#sources <- read.csv("sourcesdemo.csv",header=TRUE) # alt line if csv file

# read in your consumer data
# This is a dataset containing 8 groups of geese, with multiple individual
# geese observed per group.
